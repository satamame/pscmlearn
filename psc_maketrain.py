...
args = sys.argv
if len(args) < 2:
    print('Usage: python psc_maketrain.py model_folder')
    sys.exit()
"""
args = [
    "psc_maketrain.py",
...
list_path = "models/" + args[1] + "/ds_train_list.txt"
fts_path = "models/" + args[1] + "/mdl_fts.txt"
dest_dir = "models/" + args[1] + "/train"


# ds_train_list.txt を読み込み、ファイル名（拡張子なし）リストを作る
filenames = []
